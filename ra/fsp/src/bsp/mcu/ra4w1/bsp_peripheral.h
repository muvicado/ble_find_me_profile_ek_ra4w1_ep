...
#define BSP_PERIPHERAL_GPT_CHANNEL_MASK          (0x13FU)
...
#define BSP_PERIPHERAL_ICU_EXT_IRQ_CHANNEL_MASK  (0xCBDFU)
...
#define BSP_PERIPHERAL_OPAMP_CHANNEL_MASK        (0x5U)
...
#define BSP_PERIPHERAL_RADIO_PRESENT             (1)
...
#define BSP_PERIPHERAL_SCI_CHANNEL_MASK          (0x213U)
