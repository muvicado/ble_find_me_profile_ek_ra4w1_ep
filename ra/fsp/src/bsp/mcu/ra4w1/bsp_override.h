...
#define BSP_OVERRIDE_BLE_PACKED_OPTION
#define BSP_OVERRIDE_BLE_GATTC_RD_MULTI_REQ_PARAM_T

/* Override definitions. */

/** Alignment macro for BLE struct type definitions. */
#define BLE_PACKED_OPTION    __attribute__((aligned(1)))
