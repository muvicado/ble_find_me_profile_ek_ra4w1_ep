...
typedef enum
{
    ...
    BLE_GATS_TOGGLE_DECL_HDL = 0x0011,
    BLE_GATS_TOGGLE_VAL_HDL = 0x0012,
    BLE_IAS_DECL_HDL = 0x0013,
    BLE_IAS_GAT_INC_HDL = 0x0014,
    BLE_IAS_ALERT_LEVEL_DECL_HDL = 0x0015,
    BLE_IAS_ALERT_LEVEL_VAL_HDL = 0x0016,
} e_ble_attr_hdl_t;
